...
#define image_original "/home/ubuntu/图片/bu.png"
...
void convert_rec()
{
    ...
    image=imread(image_original,1);//读入彩色图像
...
{
    ros::init(argc, argv, "zbar_opencv1-ref");
    ros::NodeHandle n;
    ros::spin();
...
//原文：https://blog.csdn.net/orange_littlegirl/article/details/80194886 
